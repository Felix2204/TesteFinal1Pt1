              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form  method = "post" data-parsley-validate  action="verify/logar.php ">
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button value = "entrar" name="submit" type="submit"  class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"data-mdb-button-init data-mdb-ripple-init>Entrar</button>
                  </div>

                  <div class="d-flex align-items-center justify-content-center pb-4">
                    <p class="mb-0 me-2"> Não tem uma conta?</p>
                    <a href="cadastro.php" type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-dark">Cadastra-se</a> 
                  </div>
