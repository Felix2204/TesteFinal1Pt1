            ...
            <div class="row g-0">
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <form method="post" data-parsley-validate action="verify/logar.php ">
                    <?php
                    if (isset($_GET['errado'])) {
                      echo '<div style="color:#be0505;">
                   <strong>Usuário ou senha incorreta</strong></div>'
                      ;
                    }
                    ...
                    <div class="text-center pt-1 mb-5 pb-1">
                      <button value="entrar" name="submit" type="submit"
                        class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" data-mdb-button-init
                        data-mdb-ripple-init>Entrar</button>
                    </div>

                    <div class="d-flex align-items-center justify-content-center pb-4">
                      <p class="mb-0 me-2"> Não tem uma conta?</p>
                      <a href="cadastro.php" type="button" data-mdb-button-init data-mdb-ripple-init
                        class="btn btn-outline-dark">Cadastra-se</a>
                    </div>
              ...
              <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                  ...
                  <p class="small mb-0">O ServiceBell é um sistema de cadastro e contratação de serviços rapido e facil,
                    ...
                    por meio de informações visiveis aos usuários, proporcionando uma experiência de usuário intuitiva e
                    eficiente.</p>
                </div>
              </div>
            </div>
